...
export const ecoTrackMockups: MockupItem[] = [
  {
    id: 1,
    title: "Welcome Login Portal",
    imageUrl: "/src/assets/ecotrack/Welcome Login Portal.jpg",
    description: "PhilEco Ticketing & Equipment Management Welcome Screen"
  },
  {
    id: 2,
    title: "Service Portal Dashboard",
    imageUrl: "/src/assets/ecotrack/Service Portal Dashboard.jpg",
    description: "Secure authentication interface for PhilEco employees"
  },
  {
    id: 3,
    title: "Active Tickets Management Console",
    imageUrl: "/src/assets/ecotrack/Active Tickets Management Console.jpg",
    description: "Main dashboard showing active tickets and service selection"
  },
  {
    id: 4,
    title: "Resolved Support Ticket Logs",
    imageUrl: "/src/assets/ecotrack/Resolved Ticket History.jpg",
    description: "Logs of all resolved support tickets with admin final remarks" // Inayos dito
  },
  {
    id: 5,
    title: "Borrow Equipment Management",
    imageUrl: "/src/assets/ecotrack/Borrow Equipment Management.jpg",
    description: "Interface to request assets, tools, or hardware devices" // Inayos dito
  },
  {
    id: 6,
    title: "Return Assets Module",
    imageUrl: "/src/assets/ecotrack/Return Assets Module.jpg",
    description: "Tracking current borrowed assets and initiating return requests" // Inayos dito
  },
  {
    id: 7,
    title: "Notifications & Updates Hub",
    imageUrl: "/src/assets/ecotrack/Notifications & Updates Hub.jpg",
    description: "Real-time alerts on ticket status changes and admin messages" // Inayos dito
  },
  {
    id: 8,
    title: "Profile Settings Panel",
    imageUrl: "/src/assets/ecotrack/Profile Settings Panel.jpg",
    description: "User profile configurations and mobile application local settings" // Inayos dito
  }
];