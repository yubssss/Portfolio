...
export const ecoTrackScreens: ScreenItem[] = [
  ...
  { src: '/Portfolio/assets/ecotrack/Active Tickets Management Console.jpg', title: 'Active Tickets Management Console' },
  { src: '/Portfolio/assets/ecotrack/Resolved Ticket History.jpg', title: 'Resolved Support Ticket Logs' },
  { src: '/Portfolio/assets/ecotrack/Borrow Equipment Management.jpg', title: 'Borrow Equipment Management' },
  { src: '/Portfolio/assets/ecotrack/Return Assets Module.jpg', title: 'Return Assets Module' },
  { src: '/Portfolio/assets/ecotrack/Notifications & Updates Hub.jpg', title: 'Notifications & Updates Hub' },
  { src: '/Portfolio/assets/ecotrack/Profile Settings Panel.jpg', title: 'Profile Settings Panel' },
];
...
export const ecoTrackMockups: MockupItem[] = [
  ...
  { id: 3, title: 'Active Tickets Management Console', imageUrl: '/Portfolio/assets/ecotrack/Active Tickets Management Console.jpg', description: 'Main dashboard showing active tickets and service selection' },
  ...
  { id: 5, title: 'Borrow Equipment Management', imageUrl: '/Portfolio/assets/ecotrack/Borrow Equipment Management.jpg', description: 'Interface to request assets, tools, or hardware devices' },
  { id: 6, title: 'Return Assets Module', imageUrl: '/Portfolio/assets/ecotrack/Return Assets Module.jpg', description: 'Tracking current borrowed assets and initiating return requests' },
  { id: 7, title: 'Notifications & Updates Hub', imageUrl: '/Portfolio/assets/ecotrack/Notifications & Updates Hub.jpg', description: 'Real-time alerts on ticket status changes and admin messages' },
  { id: 8, title: 'Profile Settings Panel', imageUrl: '/Portfolio/assets/ecotrack/Profile Settings Panel.jpg', description: 'User profile configurations and mobile application local settings' },
];
